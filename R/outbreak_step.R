...
outbreak_step <- function(case_data = NULL, disp.iso = NULL, disp.com = NULL, r0isolated = NULL, r0community = NULL,
  ...
  # print(r0community_ca + r0community_cc)
  # print(ifelse(vect_isTRUE(case_data$adult),
  #                             r0community_aa + r0community_ac,
  #                            r0community_ca + r0community_cc))
  # print(ifelse(vect_isTRUE(case_data$isolated),
  #              case_data$r0isolated,
  #        ifelse(vect_isTRUE(case_data$adult),
  #               case_data$r0community_aa + case_data$r0community_ac, 
  #               case_data$r0community_ca + case_data$r0community_cc)))
